...
export default function SiteFooter({ tagline }) {
  return (
    <footer
      className="bg-[#171a17] px-5 pt-14 text-white sm:px-8 lg:px-10">
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-10 lg:grid-cols-[1.05fr_0.7fr_0.75fr_0.9fr]">
          <div data-animate="fade-right">
            <Link className="inline-flex items-center transition hover:scale-[1.03]" href="/">
              <Image
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              {["Free Towing", "Paid on the Spot", "All Calgary"].map((item) => (
                <span
                  className="rounded-full bg-white/8 px-3 py-1.5 text-xs font-black text-white/78 ring-1 ring-white/10 transition hover:bg-[#f4c542] hover:text-[#171a17]"
                  key={item}
                >
                  {item}
                </span>
          ...
          <div data-animate="fade-up">
            ...
            <nav className="mt-5 grid gap-3 text-sm font-black text-white/76">
              <Link className="inline-block transition hover:translate-x-1 hover:text-white" href="/">
                Home
              </Link>
              <Link className="inline-block transition hover:translate-x-1 hover:text-white" href="/about-us">
                About
              </Link>
              <Link className="inline-block transition hover:translate-x-1 hover:text-white" href="/#quote">
                Contact
              </Link>
            </nav>
          </div>
          ...
          <div
            className="lift-card rounded-[1.5rem] bg-white p-5 text-[#171a17] shadow-2xl shadow-black/20"
          ...
          >
            ...
            <a
              className="mt-5 inline-flex w-full items-center justify-center rounded-full bg-[#b5252b] px-5 py-3 text-sm font-black text-white transition hover:bg-[#171a17]"
              href="tel:+15876642401"
            >
              (587)-664-2401
            </a>
            <a
              className="mt-3 inline-flex w-full items-center justify-center rounded-full bg-[#f4c542] px-5 py-3 text-sm font-black text-[#171a17] transition hover:bg-[#f4f1e9]"
